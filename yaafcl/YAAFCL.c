...
static int
YAAFCL_CreateArchiveFromPaths(const int argc,
                              char** argv,
                              const int flags)
{
...
static int
YAAFCL_ListArchive(const int argc,
                   char** argv,
                   const int flags)
{
    (void) flags;
...
static int
YAAFCL_ExtractArchive(const int argc,
                      char** argv,
                      const int flags)
{
    if ( argc < 2)
...
static int
YAAFCL_ExtractFile(const int argc,
                   char** argv,
                   const int flags)
{  
    YAAF_Archive* p_archive = NULL;
...
static int
YAAFCL_ParseArgs(const int argc,
                 char** argv)
{
